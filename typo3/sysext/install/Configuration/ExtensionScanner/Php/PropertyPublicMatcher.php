...
return [
    ...
    'TYPO3\CMS\Backend\Controller\PageLayoutController->edit_record' => [
        'restFiles' => [
            'Breaking-80700-DeprecatedFunctionalityRemoved.rst',
            'Deprecation-79364-DeprecateMembersInPageLayoutController.rst',
        ],
    ],
    ...
    'TYPO3\CMS\Backend\Controller\PageLayoutController->externalTables' => [
        'restFiles' => [
            'Breaking-80700-DeprecatedFunctionalityRemoved.rst',
            'Deprecation-77987-DeprecatedRecordListingInPageModule.rst',
        ],
    ],
    ...
    'TYPO3\CMS\Backend\Template\DocumentTemplate->extJScode' => [
        'restFiles' => [
            'Breaking-80700-DeprecatedFunctionalityRemoved.rst',
            'Deprecation-80512-DocumentTemplate-extJScodeProperty.rst',
        ],
    ],
    ...
    'TYPO3\CMS\Frontend\ContentObject\Menu\AbstractMenuContentObject->parentMenuArr' => [
        'restFiles' => [
            'Breaking-80700-DeprecatedFunctionalityRemoved.rst',
            'Deprecation-77296-DeprecatePublicMemberParentMenuArrInAbstractMenuContentObject.rst',
        ],
    ],
    ...
    'TYPO3\CMS\Frontend\Controller\TypoScriptFrontendController->renderCharset' => [
        'restFiles' => [
            'Breaking-80700-DeprecatedFunctionalityRemoved.rst',
            'Deprecation-73794-SearchFormController-utf8_to_currentCharsetAndTSFE-renderCharset.rst',
        ],
    ],
    ...
    'TYPO3\CMS\Tstemplate\Controller->e' => [
        'restFiles' => [
