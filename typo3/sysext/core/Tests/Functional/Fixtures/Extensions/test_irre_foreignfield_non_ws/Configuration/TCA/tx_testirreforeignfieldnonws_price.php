...
return [
    ...
    'columns' => [
        ...
        'l18n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_testirreforeignfieldnonws_price}.{#pid}=###CURRENT_PID### AND {#tx_testirreforeignfieldnonws_price}.{#language_tag} IN (-1,0)',
                'default' => 0,
            ],
        ],
        'l18n_diffsource' => [
    ...
    'types' => [
        '0' => ['showitem' =>
            ...
            '--div--;LLL:EXT:test_irre_foreignfield_non_ws/Resources/Private/Language/locallang_db.xlf:tabs.visibility, language_tag, l18n_parent, l18n_diffsource, hidden, parentid',
        ],
    ],
    'palettes' => [
        '1' => ['showitem' => ''],
