...
return [
    ...
    'columns' => [
        ...
        'l18n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_testirreforeignfield_hotel}.{#pid}=###CURRENT_PID### AND {#tx_testirreforeignfield_hotel}.{#language_tag} IN (-1,0)',
                'default' => 0,
            ],
        ],
        'l18n_diffsource' => [
    ...
    'types' => [
        '0' => ['showitem' =>
            ...
            '--div--;LLL:EXT:test_irre_foreignfield/Resources/Private/Language/locallang_db.xlf:tabs.visibility, language_tag, l18n_parent, l18n_diffsource, hidden',
        ],
    ],
    'palettes' => [
        '1' => ['showitem' => ''],
